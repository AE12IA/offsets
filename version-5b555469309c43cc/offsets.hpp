// Roblox version: version-5b555469309c43cc (LIVE)
// Dumper version: 0.1.0
// Dumped by theo (https://imtheo.lol) :3
// Dumped at: 17:16 03/08/2025
// Total offsets: 106
...
namespace Offsets {
    ...
    namespace FakeDataModel {
         inline constexpr uintptr_t Pointer = 0x6edcf58;
    ...
    namespace GuiObject {
         ...
         inline constexpr uintptr_t Image = 0x848;
         ...
         inline constexpr uintptr_t TextColor3 = 0xcc0;
         inline constexpr uintptr_t Visible = 0x459;
    }

    namespace Humanoid {
         inline constexpr uintptr_t Health = 0x19c;
         inline constexpr uintptr_t HipHeight = 0xd;
    ...
    namespace MouseService {
         ...
         inline constexpr uintptr_t SensitivityPointer = 0x6f53ad0;
    }
    ...
    namespace StatsItem {
         inline constexpr uintptr_t Value = 0x279;
    }
    ...
    namespace TaskScheduler {
         ...
         inline constexpr uintptr_t Pointer = 0x6fad1e0;
    ...
    namespace VisualEngine {
         ...
         inline constexpr uintptr_t Pointer = 0x6d1e788;
         inline constexpr uintptr_t ViewMatrix = 0x4b0;
    }

    namespace Workspace {
         inline constexpr uintptr_t CurrentCamera = 0x428;
         inline constexpr uintptr_t DistributedGameTime = 0x448;
