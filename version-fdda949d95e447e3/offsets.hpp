/*
Roblox version: version-fdda949d95e447e3 (LIVE)
Dumper version: c7a9678
Dumped at: 08:10 20/11/2025
Total offsets: 178
...
#include <string>
namespace Offsets {
    inline std::string ClientVersion = "version-fdda949d95e447e3";
    ...
    namespace FFlags {
         ...
         inline constexpr uintptr_t TaskSchedulerTargetFps = 0x6f49e20;
         inline constexpr uintptr_t WebSocketServiceEnableClientCreation = 0x663c738;
    }

    namespace FakeDataModel {
         inline constexpr uintptr_t Pointer = 0x77a01c8;
    ...
    namespace MouseService {
         ...
         inline constexpr uintptr_t SensitivityPointer = 0x787a4e0;
    }
    ...
    namespace PlayerConfigurer {
         ...
         inline constexpr uintptr_t Pointer = 0x777c770;
    }
    ...
    namespace StatsItem {
         inline constexpr uintptr_t Value = 0xa0df;
    }
    ...
    namespace TaskScheduler {
         ...
         inline constexpr uintptr_t Pointer = 0x78e2e28;
    ...
    namespace VisualEngine {
         ...
         inline constexpr uintptr_t Pointer = 0x75277c0;
