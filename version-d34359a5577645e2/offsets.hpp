/*
Roblox version: version-d34359a5577645e2 (LIVE)
Dumper version: 2d7e952
Dumped at: 07:59 08/10/2025
Total offsets: 165
...
namespace Offsets {
    namespace AnimationTrack {
         ...
         inline constexpr uintptr_t IsPlaying = 0x4c8;
    ...
    namespace BasePart {
         ...
         inline constexpr uintptr_t PrimitiveFlags = 0x275;
    ...
    namespace DataModel {
         ...
         inline constexpr uintptr_t PrimitiveCount = 0x167;
         inline constexpr uintptr_t ScriptContext = 0x3d0;
         inline constexpr uintptr_t ServerIP = 0x668;
    ...
    namespace GuiObject {
         inline constexpr uintptr_t BackgroundColor3 = 0x500;
         inline constexpr uintptr_t BorderColor3 = 0x50c;
         inline constexpr uintptr_t Image = 0x9d0;
         inline constexpr uintptr_t LayoutOrder = 0x53c;
         inline constexpr uintptr_t Position = 0x4d0;
         inline constexpr uintptr_t RichText = 0xa90;
         inline constexpr uintptr_t Rotation = 0x188;
         inline constexpr uintptr_t ScreenGui_Enabled = 0x484;
         inline constexpr uintptr_t Size = 0x4f0;
         inline constexpr uintptr_t Text = 0xde8;
         inline constexpr uintptr_t TextColor3 = 0xe98;
         inline constexpr uintptr_t Visible = 0x569;
    }
    ...
    namespace Humanoid {
         ...
         inline constexpr uintptr_t HumanoidState = 0x7f8;
         inline constexpr uintptr_t HumanoidStateID = 0x3c;
    ...
    namespace MouseService {
         ...
         inline constexpr uintptr_t SensitivityPointer = 0x738bdb0;
    }
    ...
    namespace Player {
         ...
         inline constexpr uintptr_t Mouse = 0xca0;
    ...
    namespace TaskScheduler {
         ...
         inline constexpr uintptr_t Pointer = 0x7434168;
    ...
    namespace VisualEngine {
         ...
         inline constexpr uintptr_t Pointer = 0x6f6fc30;
    ...
    namespace Workspace {
         ...
         inline constexpr uintptr_t ReadOnlyGravity = 0x990;
    }
