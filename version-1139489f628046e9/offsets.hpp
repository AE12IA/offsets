/*
Roblox version: version-1139489f628046e9 (LIVE)
Dumper version: c7a9678
Dumped at: 22:30 12/12/2025
Total offsets: 177
...
#include <string>
namespace Offsets {
    inline std::string ClientVersion = "version-1139489f628046e9";
    ...
    namespace BaseScript {
         inline constexpr uintptr_t IsCoreScript = 0x4;
         inline constexpr uintptr_t ModuleFlags = 0x0;
    }
    ...
    namespace FFlags {
         inline constexpr uintptr_t DebugDisableTimeoutDisconnect = 0x67ad7a0;
         inline constexpr uintptr_t EnableLoadModule = 0x679c8f8;
         inline constexpr uintptr_t PartyPlayerInactivityTimeoutInSeconds = 0x676ba70;
         inline constexpr uintptr_t TaskSchedulerTargetFps = 0x74bfee4;
         inline constexpr uintptr_t WebSocketServiceEnableClientCreation = 0x67ba738;
    }

    namespace FakeDataModel {
         inline constexpr uintptr_t Pointer = 0x7d02728;
    ...
    namespace MouseService {
         ...
         inline constexpr uintptr_t SensitivityPointer = 0x7dae210;
    }
    ...
    namespace PlayerConfigurer {
         ...
         inline constexpr uintptr_t Pointer = 0x7ce0268;
    }
    ...
    namespace TaskScheduler {
         ...
         inline constexpr uintptr_t Pointer = 0x7e1bc88;
    ...
    namespace Workspace {
         ...
         inline constexpr uintptr_t Gravity = 0x2e8;
         inline constexpr uintptr_t GravityContainer = 0x108;
