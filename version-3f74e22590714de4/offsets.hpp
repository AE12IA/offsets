// Roblox version: version-3f74e22590714de4 (LIVE)
// Dumper version: 0.1.0
// Dumped by theo (https://imtheo.lol) :3
// Dumped at: 18:59 05/08/2025
// Total offsets: 117
...
namespace Offsets {
    namespace BasePart {
         ...
         inline constexpr uintptr_t PrimativeFlags = 0x301;
    ...
    namespace FakeDataModel {
         inline constexpr uintptr_t Pointer = 0x6e854f8;
         inline constexpr uintptr_t RealDataModel = 0x1c0;
    }

    namespace GuiObject {
         inline constexpr uintptr_t BackgroundColor3 = 0x3f0;
         inline constexpr uintptr_t BorderColor3 = 0x3fc;
         inline constexpr uintptr_t Image = 0x868;
         inline constexpr uintptr_t LayoutOrder = 0x42c;
         inline constexpr uintptr_t Position = 0x3c0;
         inline constexpr uintptr_t Rotation = 0x190;
         inline constexpr uintptr_t ScreenGui_Enabled = 0x374;
         inline constexpr uintptr_t Size = 0x3e0;
         inline constexpr uintptr_t Text = 0x8f8;
         inline constexpr uintptr_t TextColor3 = 0xd10;
         inline constexpr uintptr_t Visible = 0x459;
    }

    namespace Humanoid {
         inline constexpr uintptr_t Health = 0x19c;
         inline constexpr uintptr_t HipHeight = 0x15;
    ...
    namespace MouseService {
         ...
         inline constexpr uintptr_t SensitivityPointer = 0x6efc090;
    }
    ...
    namespace TaskScheduler {
         ...
         inline constexpr uintptr_t Pointer = 0x6f55720;
    ...
    namespace VisualEngine {
         ...
         inline constexpr uintptr_t Pointer = 0x6c11c20;
