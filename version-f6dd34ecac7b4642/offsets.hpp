...
namespace Offsets {
    ...
    namespace FFlags {
         ...
         inline constexpr uintptr_t WebSocketServiceEnableClientCreation = 0x64449e0;
    }
    ...
    namespace Misc {
         ...
         inline constexpr uintptr_t RequireLock = 0x8e0;
    ...
    namespace Workspace {
         ...
         inline constexpr uintptr_t Gravity = 0x59;
         inline constexpr uintptr_t GravityContainer = 0xf8;
