/*
Roblox version: version-89b6c70d8f7f42ac (LIVE)
Dumper version: 733edeb
Dumped at: 18:21 20/08/2025
Total offsets: 140
*/
...
namespace Offsets {
    namespace BasePart {
         inline constexpr uintptr_t AssemblyAngularVelocity = 0x164;
         inline constexpr uintptr_t AssemblyLinearVelocity = 0x158;
         inline constexpr uintptr_t Color3 = 0x1c4;
         inline constexpr uintptr_t Gravity = 0x120;
         inline constexpr uintptr_t Material = 0x2d0;
         inline constexpr uintptr_t Position = 0x14c;
         inline constexpr uintptr_t Primitive = 0x178;
         inline constexpr uintptr_t PrimitiveFlags = 0x307;
         inline constexpr uintptr_t Rotation = 0x128;
         inline constexpr uintptr_t Shape = 0x1e1;
         inline constexpr uintptr_t Size = 0x254;
    ...
    namespace FakeDataModel {
         inline constexpr uintptr_t Pointer = 0x7022fa8;
         inline constexpr uintptr_t RealDataModel = 0x1c0;
    }

    namespace GuiObject {
         inline constexpr uintptr_t BackgroundColor3 = 0x4f0;
         inline constexpr uintptr_t BorderColor3 = 0x4fc;
         inline constexpr uintptr_t Image = 0xa00;
         inline constexpr uintptr_t LayoutOrder = 0x52c;
         inline constexpr uintptr_t Position = 0x4c0;
         inline constexpr uintptr_t Rotation = 0x190;
         inline constexpr uintptr_t ScreenGui_Enabled = 0x474;
         inline constexpr uintptr_t Size = 0x4e0;
         inline constexpr uintptr_t Text = 0xa98;
         inline constexpr uintptr_t TextColor3 = 0xeb0;
         inline constexpr uintptr_t Visible = 0x559;
    }

    namespace Humanoid {
         inline constexpr uintptr_t Health = 0x19c;
         inline constexpr uintptr_t HipHeight = 0x29;
    ...
    namespace MeshPart {
         ...
         inline constexpr uintptr_t Texture = 0x138;
    }
    ...
    namespace Player {
         ...
         inline constexpr uintptr_t MaxZoomDistance = 0x2b8;
         inline constexpr uintptr_t MinZoomDistance = 0x2bc;
         inline constexpr uintptr_t ModelInstance = 0x328;
         inline constexpr uintptr_t Mouse = 0xc58;
         inline constexpr uintptr_t Team = 0x248;
         inline constexpr uintptr_t UserId = 0x260;
    }
    ...
    namespace TaskScheduler {
         ...
         inline constexpr uintptr_t Pointer = 0x70f31e0;
    ...
    namespace VisualEngine {
         ...
         inline constexpr uintptr_t Pointer = 0x6d7cda0;
