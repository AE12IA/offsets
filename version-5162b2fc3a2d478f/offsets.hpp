/*
Roblox version: version-5162b2fc3a2d478f (LIVE)
Dumper version: c7a9678
Dumped at: 17:41 05/12/2025
Total offsets: 176
...
#include <string>
namespace Offsets {
    inline std::string ClientVersion = "version-5162b2fc3a2d478f";
    ...
    namespace FFlags {
         ...
         inline constexpr uintptr_t TaskSchedulerTargetFps = 0x74bfbe8;
         inline constexpr uintptr_t WebSocketServiceEnableClientCreation = 0x67ba738;
    }

    namespace FakeDataModel {
         inline constexpr uintptr_t Pointer = 0x7d02458;
    ...
    namespace MouseService {
         ...
         inline constexpr uintptr_t SensitivityPointer = 0x7dadf40;
    }
    ...
    namespace PlayerConfigurer {
         ...
         inline constexpr uintptr_t Pointer = 0x7cdff68;
    }
    ...
    namespace StatsItem {
         inline constexpr uintptr_t Value = 0xaef;
    }
    ...
    namespace TaskScheduler {
         ...
         inline constexpr uintptr_t Pointer = 0x7e1b9c8;
    ...
    namespace VisualEngine {
         ...
         inline constexpr uintptr_t Pointer = 0x7a681f0;
