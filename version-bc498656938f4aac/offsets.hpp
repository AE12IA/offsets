/*
Roblox version: version-bc498656938f4aac (LIVE)
Dumper version: f5dd3eb
Dumped at: 23:08 02/09/2025
Total offsets: 159
...
namespace Offsets {
    namespace BasePart {
         ...
         inline constexpr uintptr_t PrimitiveFlags = 0x243;
    ...
    namespace FakeDataModel {
         inline constexpr uintptr_t Pointer = 0x7097018;
    ...
    namespace MouseService {
         ...
         inline constexpr uintptr_t SensitivityPointer = 0x710c710;
    }
    ...
    namespace Player {
         ...
         inline constexpr uintptr_t Gender = 0xdd0;
    ...
    namespace TaskScheduler {
         ...
         inline constexpr uintptr_t Pointer = 0x7167520;
    ...
    namespace VisualEngine {
         ...
         inline constexpr uintptr_t Pointer = 0x6dec860;
    ...
    namespace Workspace {
         ...
         inline constexpr uintptr_t DistributedGameTime = 0x27;
