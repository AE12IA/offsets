/*
Roblox version: version-1a00fc65f08f4717 (LIVE)
Dumper version: c7a9678
Dumped at: 18:11 03/02/2026
Total offsets: 180
...
#include <string>
namespace Offsets {
    inline std::string ClientVersion = "version-1a00fc65f08f4717";
    ...
    namespace FFlags {
         inline constexpr uintptr_t DebugDisableTimeoutDisconnect = 0x6896e08;
         inline constexpr uintptr_t EnableLoadModule = 0x688be60;
         inline constexpr uintptr_t PartyPlayerInactivityTimeoutInSeconds = 0x684692c;
         inline constexpr uintptr_t PhysicsSenderMaxBandwidthBps = 0x6846dd8;
         inline constexpr uintptr_t PhysicsSenderMaxBandwidthBpsScaling = 0x6846dd8;
         inline constexpr uintptr_t TaskSchedulerTargetFps = 0x75a5be8;
         inline constexpr uintptr_t WebSocketServiceEnableClientCreation = 0x68a3ac8;
         inline constexpr uintptr_t WorldStepMax = 0x684aa94;
         inline constexpr uintptr_t WorldStepsOffsetAdjustRate = 0x684aa90;
    }

    namespace FakeDataModel {
         inline constexpr uintptr_t Pointer = 0x7c73808;
    ...
    namespace MouseService {
         ...
         inline constexpr uintptr_t SensitivityPointer = 0x7cfb2e0;
    }
    ...
    namespace PlayerConfigurer {
         ...
         inline constexpr uintptr_t Pointer = 0x7c518c0;
    }
    ...
    namespace TaskScheduler {
         ...
         inline constexpr uintptr_t Pointer = 0x7d31788;
    ...
    namespace VisualEngine {
         ...
         inline constexpr uintptr_t Pointer = 0x775c850;
