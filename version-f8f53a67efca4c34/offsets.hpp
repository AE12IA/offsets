/*
Roblox version: version-f8f53a67efca4c34 (LIVE)
Dumper version: c7a9678
Dumped at: 18:22 31/12/2025
Total offsets: 175
...
#include <string>
namespace Offsets {
    inline std::string ClientVersion = "version-f8f53a67efca4c34";

    namespace AnimationTrack {
         inline constexpr uintptr_t Animation = 0xd0;
         inline constexpr uintptr_t Animator = 0x118;
         inline constexpr uintptr_t IsPlaying = 0x28f;
    ...
    namespace FFlags {
         inline constexpr uintptr_t DebugDisableTimeoutDisconnect = 0x67ae7d0;
         ...
         inline constexpr uintptr_t WebSocketServiceEnableClientCreation = 0x67bb7a8;
    }
