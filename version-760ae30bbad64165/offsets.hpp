/*
Roblox version: version-760ae30bbad64165 (LIVE)
Dumper version: c7a9678
Dumped at: 20:14 26/01/2026
Total offsets: 175
...
#include <string>
namespace Offsets {
    inline std::string ClientVersion = "version-760ae30bbad64165";

    namespace AnimationTrack {
         inline constexpr uintptr_t Animation = 0xd0;
         inline constexpr uintptr_t Animator = 0x118;
         inline constexpr uintptr_t IsPlaying = 0x285;
    ...
    namespace Humanoid {
         inline constexpr uintptr_t AutoRotate = 0xfd;
