...
#include <string>
namespace Offsets {
    inline std::string ClientVersion = "version-eaebe135b3ec446b";
    ...
    namespace MouseService {
         inline constexpr uintptr_t InputObject = 0xa0;
         inline constexpr uintptr_t MousePosition = 0xa0;
    ...
    namespace Workspace {
         ...
         inline constexpr uintptr_t Gravity = 0x26d;
